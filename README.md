...
4. 測定結果を確認して「チュートリアルへ」を押します。
5. チュートリアルで、紫のモンスターを両脚ジャンプと着地で踏み潰します。
6. 左から来る黄色い障害物に対して、上体を右へ曲げて回避します。
7. 近づくボスのエネルギー弾に対して、脚を動かさず上体をねじって反射します。
8. 3種類に成功したら「本番スタート！」を押します。
9. 本番では、表示された敵や障害物に合わせて3つの動きを使い分けます。
10. バトル開始から3分後に、得点・撃破・回避・反射の結果が表示されます。途中で「ここまでの結果を見る」を押すこともできます。
11. 結果画面は10秒後に自動でトップ画面へ戻ります。
